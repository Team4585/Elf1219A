...
public class Elf1219AJoystick extends HuskyJoystick{
  private static final int Elf1219A_JOYSTICK_PORT = 0;
  ...
  public Elf1219AJoystick(){
      super(Elf1219A_JOYSTICK_PORT);
  }
